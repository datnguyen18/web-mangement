                    ...
                    this.itemRef.child("SoftDrink")
                        ...
                        .once("value", snapshot => {
                            this.itemRef.child("SoftDrink")
                                .child(this.state.name)
                                .set({
                                    quantity: parseInt(this.state.quantity) + parseInt(snapshot.val()["quantity"])
                                })
                        })
                }else{
        ...
        return (
            <div className="container">
                <form>
                    ...
                    <div class="row">
                        <button onClick={this.addSoftDrink} type="button" class="btn btn-danger">Add Ingredient</button>
                        <button onClick={this.addSoftDrink} type="button" class="btn btn-danger">Add Ingredient</button>
